...
![Version](https://img.shields.io/badge/Version-2.2.0-yellowgreen?style=for-the-badge)
...
> The target API level required for this SDK is `34`
...
| `store`                   | `Optional`          | `Gr4vyStore.TRUE`, `Gr4vyStore.FALSE`, `Gr4vyStore.ASK`, `Gr4vyStore.PRESELECT` - Explicitly store the payment method, ask the buyer or preselect it by default. Requires `buyerId` or `buyerExternalIdentifier`. Sent to Embed as `true`, `false`, `'ask'` or `'preselect'` respectively.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
